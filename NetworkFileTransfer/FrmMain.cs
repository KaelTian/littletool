...
namespace NetworkFileTransfer
{
    public partial class FrmMain : Form
    {
        ...
        private void OnProgressChanged(object? sender, TransferEventArgs e)
        {
            ...
            _transferredBytes = e.TransferredBytes ?? 0;
            _totalBytes = e.TotalBytes ?? 0;
        ...
        private void OnStatusChanged(object? sender, TransferEventArgs e)
        {
            ...
            AddLog(e.Message ?? string.Empty, e.IsError.HasValue && e.IsError.Value ? Color.Red : Color.Black);
